...
let StudentService = class StudentService {
    ...
    async create(data) {
        ...
        if (res) {
            const data = Object.assign(Object.assign({}, student), { message: 'Data Added successfully!' });
            return data;
        }
    }
    async read(id) {
    ...
    async update(id, data) {
        ...
        if (res) {
            ...
            const data = Object.assign(Object.assign({}, updateData), { message: 'updated successfully' });
            return data;
        }
    }
    async delete(id) {
